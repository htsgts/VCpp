...
#include <Windows.h>
// 상수로 각 버튼의 ID를 정의
#define ID_BOX_BUTTON   101
#define ID_CIRCLE_BUTTON  102
#define ID_BONO_BUTTON   103
#define ID_RYAN_BUTTON   104
#define ID_CUBE_BUTTON   105
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_COMMAND:
    {
        ...
        case ID_RYAN_BUTTON:
        {
            HDC hdc = GetDC(hWnd);
            // Draw Ryan
            // Add your code to draw Ryan here
            ReleaseDC(hWnd, hdc);
        }
        break;
        ...
        case ID_CUBE_BUTTON:
        {
            HDC hdc = GetDC(hWnd);
            // Draw a cube
            // Add your code to draw a cube here
            ReleaseDC(hWnd, hdc);
        }
        break;
